<template>
	<div class="mx-auto mt-6" style="max-width: 35%"> <!-- TODO max width 要刪除 -->
          ...
          <v-row class="mt-6" no-gutters>
	        ...
	        <v-row no-gutters>
		        <v-col cols="12">
			        ...
			        <div class="mx-auto mt-2" style="max-width: 80%">
				        <v-text-field outlined dense v-model="user.address"></v-text-field>
			        </div>
		        </v-col>
	        </v-row>
	        <v-row no-gutters>
	        ...
	        <v-row no-gutters>
		        <v-col cols="12">
			        <span class="ml-14">自我簡介</span><span style="float: right" class="mr-14"><v-icon color="blue">mdi-chat-question</v-icon>看看範例</span>
			        <div class="mx-auto mt-2" style="max-width: 80%">
				        <v-text-field outlined dense v-model="user.name"></v-text-field>
			        </div>
		        </v-col>
...
<script>
  ...
  data: () => ({
    panel: [0],
      menu: false,
		  militaryItems:[{text:'已服役',value: 1},{text:'未服役',value: 0}],
    user: {
        militaryService: 0
    }
  }),
