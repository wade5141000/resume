    ...
    <v-col justify="center" cols="12" class="pa-0 justify-center text-center">
      ...
      >
        ...
        >
          ...
          <v-col col="12" lg="4" sm="4" class="my-1">
            <v-icon class="mr-1">mdi-calendar-month</v-icon>生日：5月5日
          </v-col>
          <v-col col="12" lg="4" sm="4" class="my-1"> 性別：男 </v-col>
          <v-col col="12" lg="4" sm="4" class="my-1">
            <v-icon class="mr-1">mdi-phone</v-icon>電話：0912-345-678
          </v-col>
          <v-col col="12" lg="4" sm="4" class="my-1">
      ...
      >
        ...
        >
          <h4>
            現職是一位UI設計師，從事設計工作約十年經驗。包含平面、多媒體、網頁、簡報、UI及APP設計等等，UI設計方面參與了許多
            kiosk互動UI、sass後台、專案網站及app的項目設計。
          </h4>
        </v-col>
          ...
          <v-timeline align-top :dense="$vuetify.breakpoint.smAndDown">
            ...
            >
              <v-card :color="edu.color" dark width="800">
                <v-card-title class="pa-5 pt-3 pl-5" v-text="edu.school">
                </v-card-title>
                <v-card-subtitle
          ...
          <v-timeline align-top :dense="$vuetify.breakpoint.smAndDown">
            ...
            >
              <v-card :color="job.color" dark width="1000">
                <v-card-title class="pa-5 pt-3 pl-5" v-text="job.jobtitle">
                </v-card-title>
                <v-card-subtitle
    ...
    jobs: [
      {
        ...
        jobtitle: "UI設計師",
        work:
          "VI/Media Kit/平面/海報/型錄/DM/EDM/banner 網站維護/專案網站建置/APP/UI設計 設計製作平面、海報、型錄、DM及EDM…等各種輸出設計 banner、電子報、EDM、電子賀卡、活動專案網頁、UI…等設計"
      },
      {
        color: "blue-grey",
        icon: "mdi-book-variant",
